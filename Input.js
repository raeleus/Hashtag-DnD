      ...
      if (/^\d+(\s.*)?$/gi.test(text)) {
        ...
        switch (parseInt(value)) {
          ...
          case 76:
            ...
            break
          case 77:
            state.tempEnemy = createEnemy("Adult Bronze Mecha Dragon", calculateRoll("17d12+102"), 19, 12, "6d6+21", "d20", "Repulsion Breath", "Lightning Breath12d10", "Wing Attack2d6+6")
            break
          case 78:
            state.tempEnemy = createEnemy("Adult Copper Mecha Dragon", calculateRoll("16d12+80"), 18, 11, "6d6+18", "d20+1", "Acid Breath12d8", "Slowing Breath", "Wing Attack2d6+6")
            break
          case 79:
          ...
          case 105:
            ...
            break
          case 106:
            state.tempEnemy = createEnemy("Ancient Red Mecha Dragon", calculateRoll("21d20+147"), 22, 15, "6d8+30", "d20+2", "Fire Breath26d6", "Wing Attack2d6+10")
            break
          case 107:
